...
import (
	...
	yooerror "github.com/PetPrivet/yookassa-sdk-go/yookassa/errors"
	yoopayment "github.com/PetPrivet/yookassa-sdk-go/yookassa/payment"
)
...
func (p *PaymentHandler) CreatePayment(payment *yoopayment.Payment) (*yoopayment.Payment, error) {
	...
	if paymentResponse.Confirmation == nil && (payment == nil || payment.PaymentMethodID == "") {
